...
export default function Hero() {
  ...
  const [statsRef, statsVisible] = useScrollReveal('hero-stats', { threshold: 0.3 })
      ...
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-8 text-center">
        ...
        >
          <motion.div
            ...
            className="w-full rounded-lg border border-border dark:border-dark-border bg-surface dark:bg-dark-surface px-4 py-3 text-center font-mono text-sm"
          >
          ...
          <motion.div variants={blockVariants} className="flex flex-col items-center gap-3">
          ...
          <motion.p
            variants={blockVariants}
            className="max-w-2xl text-textDim dark:text-dark-textDim"
          >
            Desarrollador de software especializado en backend, construyendo sistemas
            robustos y escalables. Placeholder — se reemplaza con datos reales en la
            capa de datos.
          </motion.p>

          <motion.div variants={blockVariants} className="flex flex-wrap justify-center gap-3">
